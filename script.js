...
function playGames(player){
  ...
  document.querySelector('.js-moves').innerHTML = `You <img src="${player}-emoji.png" alt="icon.png" class="icon"> <img src="${comp}-emoji.png" alt="icon.png" class="icon"> Computer`;
